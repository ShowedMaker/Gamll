...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if (userInfo == null) {
            throw new RuntimeException("用户不粗真乃！");
        }
        ...
        //返回结果
        //这一步跑完oauth框架开始帮你开始校验密码
        return userDetails;
    }

    public static void main(String[] args) {
        String a = "$2a$10$cQMf3DNGCCYx2MXN5LXoXu7CmynGHIqypYbttDndvnc9fT9hf0Bb6";
        byte[] decode = Base64.getDecoder().decode(a);
        System.out.println(new String(decode));

        String b = "atguigu";
        byte[] encode = Base64.getEncoder().encode(b.getBytes());
