...
public class AddSeckillGoodsFromDBToRedisTask {
    ...
    public void addSeckillGoodsFromDBToRedis(){
        ...
        dateMenus.stream().forEach(date -> {
            ...
            String endTime = DateUtil.data2str(endTimes, DateUtil.PATTERN_YYYY_MM_DDHHMM);
            ...
            //gt 就是 greater than大于，lt 就是 less than小于，
            //ge 就是 greater than or equal 大于等于，le 就是 less than or equal 小于等于
...
//                    messageProperties.setExpiration((liveTime+30000) + "");
